...
\textit{Correcting faulty code}       & medium & medium & medium & medium & medium \\
\textit{Improving existing code}      & no & no & no & no & no \\
\textit{Generating new code}          & medium & no & no & no & yes \\
\textit{Layout and formatting}        & no & no & no & no & no \\
\textit{Text correction and rewording}& heavy & heavy & no & heavy & heavy \\
\bottomrule
\end{tabular}
...
The bar plot reveals substantial differences in youth unemployment across subcontinents. **Northern Africa** and **Southern Europe** stand out with the highest median youth unemployment rates, both exceeding 25-30%. On the other end of the spectrum, **Eastern Asia** and **Central Asia** show the lowest median rates. It is interesting to note that even within continents like Europe, there is a wide gap between the youth unemployment levels in Southern Europe compared to Northern or Western Europe.
...
Adding error bars representing the interquartile range (IQR) provides a clearer picture of the data's variability. While some regions like **Western Asia** have a high median and a relatively wide IQR, others like **South-eastern Asia** show much lower variability. This highlights that in certain regions, youth unemployment is consistently high or low, whereas in others, there is a broader range of experiences across different countries.
